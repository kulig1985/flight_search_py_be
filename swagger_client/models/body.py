...
class Body(object):
    ...
    @property
    def requests(self):
        """Gets the requests of this Body.  # noqa: E501

        List of requests per each sector  # noqa: E501

        :return: The requests of this Body.  # noqa: E501
        :rtype: list[BodyRequests]
        """
        return self._requests

    @requests.setter
    def requests(self, requests):
        """Sets the requests of this Body.

        List of requests per each sector  # noqa: E501

        :param requests: The requests of this Body.  # noqa: E501
        :type: list[BodyRequests]
        """
        if requests is None:
