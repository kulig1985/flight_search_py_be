...
class Body2(object):
    ...
    """
    swagger_types = {
        'via_blocks': 'list[Body2ViaBlocks]'
    }

    attribute_map = {
        'via_blocks': 'via_blocks'
    }

    def __init__(self, via_blocks=None):  # noqa: E501
        """Body2 - a model defined in Swagger"""  # noqa: E501
        self._via_blocks = None
        self.discriminator = None
        self.via_blocks = via_blocks

    @property
    def via_blocks(self):
        """Gets the via_blocks of this Body2.  # noqa: E501

        List of requests per each sector  # noqa: E501

        :return: The via_blocks of this Body2.  # noqa: E501
        :rtype: list[Body2ViaBlocks]
        """
        return self._via_blocks

    @via_blocks.setter
    def via_blocks(self, via_blocks):
        """Sets the via_blocks of this Body2.

        List of requests per each sector  # noqa: E501

        :param via_blocks: The via_blocks of this Body2.  # noqa: E501
        :type: list[Body2ViaBlocks]
        """
        if via_blocks is None:
            raise ValueError("Invalid value for `via_blocks`, must not be `None`")  # noqa: E501

        self._via_blocks = via_blocks
