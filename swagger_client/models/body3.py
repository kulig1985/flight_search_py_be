...
class Body3(object):
    ...
    def __init__(self, via=None):  # noqa: E501
    ...
    @property
    def via(self):
        """Gets the via of this Body3.  # noqa: E501

        List of sector requests upon which the itinerary should be built.  # noqa: E501

        :return: The via of this Body3.  # noqa: E501
        :rtype: list[Body3Via]
        """
        return self._via
    ...
    @via.setter
    def via(self, via):
        """Sets the via of this Body3.

        List of sector requests upon which the itinerary should be built.  # noqa: E501

        :param via: The via of this Body3.  # noqa: E501
        :type: list[Body3Via]
        """
        if via is None:
