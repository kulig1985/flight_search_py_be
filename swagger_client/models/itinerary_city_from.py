...
class ItineraryCityFrom(object):
    ...
    def __init__(self):  # noqa: E501
        """ItineraryCityFrom - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItineraryCityFrom, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItineraryCityFrom):
            return False
