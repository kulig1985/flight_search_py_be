...
class FollowingTechnicalStop(object):
    ...
    def __init__(self):  # noqa: E501
        """FollowingTechnicalStop - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FollowingTechnicalStop, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FollowingTechnicalStop):
            return False
